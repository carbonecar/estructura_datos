...
Logger::Logger(int cantRegistros) {
...
Logger* Logger::getInstance(int cantRegistros){
	if ( Logger::logger  == NULL )
		Logger::logger = new Logger(cantRegistros);
...
int Logger::buscar(std::string cadena) {
	...
	Logger* logger = Logger::getInstance(Logger::limit);
